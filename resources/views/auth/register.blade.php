    ...
    <div class="flex justify-center items-center h-screen bg-gray-200">
        <div class="bg-white rounded shadow-lg w-[400px] min-h-[100px] p-9">
            ...
            <div class="mb-5">
                ...
                <input class="rounded font-semibold border border-solid border-slate-100 shadow-lg block px-5 py-2 w-full focus:outline-blue-700" type="email" name="email" autocomplete="off" placeholder="email" />
            </div>
            <div class="mb-5">
                <label for="no_hp" class="font-bold block mb-3">Telepon</label>
                <input class="rounded font-semibold border border-solid border-slate-100 shadow-lg block px-5 py-2 w-full focus:outline-blue-700" type="text" name="no_hp" autocomplete="off" placeholder="no_hp" />
            </div>
            <div class="mb-5">
